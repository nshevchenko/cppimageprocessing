...
class MyFrame : public wxFrame {
 protected:
   ...
   /* declear message handler */
    void NegativeLinear(wxCommandEvent & event);
    void LogaritmicFun(wxCommandEvent & event); //---> To be modified!
    void PowerLawFun(wxCommandEvent & event); //---> To be modified!
    void RandomLookUp(wxCommandEvent & event); //---> To be modified!
